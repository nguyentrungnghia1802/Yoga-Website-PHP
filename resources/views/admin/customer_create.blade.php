...
@section('title', 'Tạo Học viên mới - Admin')
...
<div class="page-header">
    ...
    <div class="header-content">
        ...
        <p>Thêm học viên mới vào hệ thống</p>
    </div>
</div>
...
<div class="form-container">
    <form method="POST" action="{{ route('admin.customers.store') }}">
        ...
        <div class="form-group full-width">
            ...
            <textarea id="note" name="note" rows="4" placeholder="Ghi chú thêm về học viên...">{{ old('note') }}</textarea>
        </div>
