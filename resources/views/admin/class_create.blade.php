...
@section('title', 'Tạo Lớp học mới - Admin')
...
<div class="page-header">
    ...
    <div class="header-content">
        ...
        <p>Thêm lớp học mới vào hệ thống</p>
    </div>
</div>
    ...
    <form method="POST" action="{{ route('admin.classes.store') }}">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" id="lich_hoc" name="lich_hoc" value="{{ old('lich_hoc') }}" placeholder="Ví dụ: Thứ 2, 4, 6" required>
            </div>

            <div class="form-group">
                <label for="location">📍 Địa điểm <span class="required">*</span></label>
                <input type="text" id="location" name="location" value="{{ old('location') }}" placeholder="Ví dụ: Phòng tập A1" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="quantity" name="quantity" value="{{ old('quantity') }}" min="1" max="50" required>
            </div>
        ...
        <div class="form-group full-width">
            ...
            <textarea id="description" name="description" rows="4" placeholder="Mô tả chi tiết về lớp học...">{{ old('description') }}</textarea>
        </div>
